      ...
      >
        ...
        <div
          style={{
            ...
            padding: "7px 8px 6px",
            boxShadow:
              "0 0 28px rgba(99,102,241,0.18), 0 0 60px rgba(0,0,0,0.5)",
            position: "relative",
            overflow: "hidden",
          }}
        >
          ...
          <div className="flex items-center gap-1 mb-2">
            <div
              ...
              style={{ width: 5, height: 5, background: "#ff5f57" }}
            />
            <div
              className="rounded-full"
              style={{ width: 5, height: 5, background: "#ffbd2e" }}
            />
            <div
              className="rounded-full"
              style={{ width: 5, height: 5, background: "#28c940" }}
            />
            <div
              className="font-mono flex-1 text-center"
              style={{ color: "rgba(255,255,255,0.18)", fontSize: "7px" }}
            >
              bhavya — projects
            </div>
          </div>
          ...
          {/* Blinking cursor */}
          <div
            className="font-mono mt-2 flex items-center gap-1"
            style={{ fontSize: "8px", color: "rgba(99,102,241,0.6)" }}
          >
            <span>›</span>
            <motion.span
              animate={{ opacity: [1, 0] }}
              ...
              >
                ...
                {PROJECTS.map((p, idx) => (
                  <button
                    ...
                    style={{
                      background:
                        activeProject === idx ? `${p.accent}18` : "transparent",
                      borderLeft:
                        activeProject === idx
                          ? `2px solid ${p.accent}`
