...
export default function Books() {
  ...
  const addChapter = () => {
    if (!newHeading.trim() || !newBody.trim()) return;
    ...
    setBooks((prev) =>
      prev.map((b) =>
        b.id === openBookId ? { ...b, chapters: [...b.chapters, chapter] } : b
      )
    );
    setNewHeading("");
    setNewBody("");
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{ width: 20, background: book.spineColor, zIndex: 2 }}
              />
              ...
              <div
                ...
                style={{ marginLeft: 20, padding: "0 20px 24px", flex: 1 }}
              >
                {/* Add chapter form */}
                <AnimatePresence>
                  {addingChapter && (
                    ...
                    >
                      <div className="font-mono text-xs mb-3" style={{ color: "#b8966e" }}>
                        new chapter
                      </div>
                      <input
                        type="text"
                      ...
                      <div className="flex gap-3 mt-3">
                        <button
                          className="font-mono text-xs px-4 py-1.5 rounded transition-opacity hover:opacity-80"
                ...
                {book.chapters.length === 0 && !addingChapter && (
                  <div
                    className="font-serif text-center py-12"
                    style={{ color: "rgba(139,115,85,0.5)", fontSize: "14px" }}
                  >
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-1">
                      ...
                      <button
                        ...
                        style={{ color: "#c0a080", marginLeft: 12 }}
                    ...
                    <h3
                      ...
                      style={{ color: "#2a1a0a", lineHeight: 1.25 }}
                    >
                      {chapter.heading}
                    </h3>
                    <p
